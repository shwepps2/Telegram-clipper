...
def main():
    ...
    app.add_handler(CommandHandler("vibe_general", cmd_set_vibe))
    app.add_handler(CommandHandler("vibe_sports", cmd_set_vibe))
    app.add_handler(CommandHandler("vibe_podcast", cmd_set_vibe))
    app.add_handler(CommandHandler("vibe_gaming", cmd_set_vibe))
    app.add_handler(CommandHandler("vibe_education", cmd_set_vibe))
